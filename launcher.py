...
programs = [
    ...
    {"name": "Hamac", "path": os.path.join("Hamak", "gui.py"), "description": "Hamac ziała na zasadzie przesunięcia wartości bajtów w danych i jest wzorowany na podstawowych operacjach używanych w szyfrowaniu, takich jak suma modulo. Każdy bajt danych (np. znak tekstu lub część pliku) jest modyfikowany poprzez dodanie wartości klucza (+ klucz) i obliczenie wyniku modulo 256. Dzięki temu wynik zawsze mieści się w zakresie wartości bajtu (0-255)."},
